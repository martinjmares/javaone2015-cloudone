...
import org.glassfish.jersey.gson.internal.GsonProvider;
...
public class GsonFeature implements Feature {
    ...
    private static final String JSON_FEATURE = GsonFeature.class.getSimpleName();

    private final GsonBuilder gsonBuilder;

    public GsonFeature(GsonBuilder gsonBuilder) {
